  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="w-[400px] ml-3 mr-2 mb-2">
        <h2 className="font-semibold mb-0 text-slate-950">Remote LLM Setup</h2>
        ...
        <h4 className="text-slate-900 mb-1">API URL</h4>
        {/* Forc */}
        <input
          type="text"
          placeholder="API URL"
          ...
          className="block w-full px-3 py-2 mb-2 border border-slate-300 box-border rounded-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out"
        />
        ...
        <h4 className="text-slate-900 mb-1">Optional API Key</h4>
        <input
          type="text"
          placeholder="API Key"
          value={apiKey}
        ...
        <h4 className="text-slate-900 mb-1">Context Length</h4>
        <CustomSelect
        ...
        <Button
          className="bg-slate-300 border-none h-8 hover:bg-slate-100 cursor-pointer text-center pt-0 pb-0 pr-2 pl-2 mt-3 w-[80px]"
          onClick={handleSave}
          placeholder=""
        >
          Save
